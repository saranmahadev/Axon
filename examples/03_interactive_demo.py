...
class InteractiveDemo:
    ...
    async def add_memory(self):
        ...
        privacy_input = input("  Privacy level (public/sensitive/private, default public): ").strip()
        privacy_level = privacy_input if privacy_input in ["public", "sensitive", "private"] else "public"
    ...
    async def search_memories(self):
        ...
        for i, result in enumerate(results, 1):
            ...
            print(f"   Importance: {'⭐' * int(result.metadata.importance * 5)} ({result.metadata.importance:.2f})")
    ...
    async def view_statistics(self):
        ...
        print(f"Collection: interactive_demo")
        print(f"Backend: Qdrant (http://localhost:6333)")
