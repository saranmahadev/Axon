...
from src.axon.models import MemoryEntry, MemoryMetadata, Filter, ProvenanceEvent
...
class MultiTenantMemorySystem:
    ...
    async def provision_organization(self, org_id: str, initial_data: list[tuple[str, list[float]]]):
    ...
    async def create_team_workspace(self, org_id: str, team_id: str, team_docs: list[tuple[str, list[float]]]):
...
async def main():
    ...
    system = MultiTenantMemorySystem(
    ...
    techcorp_kb = [
        ...
        ("TechCorp security guidelines require 2FA for all employees.", create_embedding("policy3")),
    ]
