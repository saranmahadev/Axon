...
async def main():
    ...
    for i in range(1, 6):
        ...
        if results:
            ...
            if new_tier != initial_tier and i == 3:
                ...
                print(f"     Reason: Frequent access pattern detected")
                print(f"     Action: Moving memory to higher tier\n")
    ...
    for decay_step in range(1, 4):
        ...
        if new_tier != current_tier:
            ...
            print(f"     Reason: Importance decreased below threshold")
            print(f"     Action: Moving memory to lower tier")
