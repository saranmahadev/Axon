...
def mock_router():
    ...
    router.get_tier_stats = Mock(return_value={
...
class TestStoreMethod:
    ...
    @pytest.mark.asyncio
    async def test_store_with_metadata(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_with_importance(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_with_tags(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_with_explicit_tier(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_empty_content_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_invalid_importance_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_invalid_tier_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_generates_unique_ids(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_store_creates_trace_event(self, mock_config, mock_router, mock_registry, mock_policy_engine):
...
class TestRecallMethod:
    ...
    @pytest.mark.asyncio
    async def test_recall_with_k_limit(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        results = await system.recall("test query", k=10)
        
        call_args = mock_router.route_recall.call_args
        assert call_args[1]['k'] == 10
    
    @pytest.mark.asyncio
    async def test_recall_with_filter(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        results = await system.recall("test query", filter=filter_obj)
        
        call_args = mock_router.route_recall.call_args
        assert call_args[1]['filter'] == filter_obj
    
    @pytest.mark.asyncio
    async def test_recall_specific_tiers(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        results = await system.recall("test query", tiers=["persistent", "session"])
        
        call_args = mock_router.route_recall.call_args
        assert call_args[1]['tiers'] == ["persistent", "session"]
    
    @pytest.mark.asyncio
    async def test_recall_with_min_importance(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_recall_empty_query_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        """Test recall with empty query raises ValueError."""
        system = MemorySystem(
            config=mock_config,
            router=mock_router,
            registry=mock_registry,
    ...
    @pytest.mark.asyncio
    async def test_recall_invalid_k_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_recall_invalid_tiers_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_recall_invalid_min_importance_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_recall_creates_trace_event(self, mock_config, mock_router, mock_registry, mock_policy_engine):
...
class TestTracingAndStatistics:
    ...
    @pytest.mark.asyncio
    async def test_get_trace_events(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_get_trace_events_filtered(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_get_trace_events_limited(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    def test_clear_trace_events(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        system._trace_events.append(TraceEvent(
    ...
    def test_enable_disable_tracing(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    def test_get_statistics(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        mock_router.get_tier_stats = Mock(return_value={
...
class TestExportMethod:
    ...
    @pytest.mark.asyncio
    async def test_export_all_tiers(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_export_specific_tier(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_export_without_embeddings(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_export_with_filter(self, mock_config, mock_router, mock_registry, mock_policy_engine):
        ...
        entry = MemoryEntry(
            id="id1",
            text="Test",
            metadata=MemoryMetadata(importance=0.9, tags=["important"])
        )
        ...
        data = await system.export(filter=filter_obj)
    ...
    @pytest.mark.asyncio
    async def test_export_invalid_tier_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_export_creates_trace_event(self, mock_config, mock_router, mock_registry, mock_policy_engine):
...
class TestImportMethod:
    ...
    @pytest.mark.asyncio
    async def test_import_with_overwrite(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_import_without_overwrite_skips(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_import_with_tier_mapping(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_import_invalid_data_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_import_creates_trace_event(self, mock_config, mock_router, mock_registry, mock_policy_engine):
...
class TestSyncMethod:
    ...
    @pytest.mark.asyncio
    async def test_sync_with_delete_source(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_conflict_resolution_newer(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_conflict_resolution_target(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_with_filter(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_invalid_tiers_raise(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_invalid_resolution_raises(self, mock_config, mock_router, mock_registry, mock_policy_engine):
    ...
    @pytest.mark.asyncio
    async def test_sync_creates_trace_event(self, mock_config, mock_router, mock_registry, mock_policy_engine):
...
class TestContextManager:
    ...
    @pytest.mark.asyncio
    async def test_async_context_manager(self, mock_config, mock_router, mock_registry, mock_policy_engine):
