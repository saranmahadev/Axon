...
from axon.core.summarizer import Summarizer, LLMSummarizer
...
class TestLLMSummarizerSummarize:
    ...
    async def test_summarize_basic(self, summarizer, sample_entries):
        ...
        with patch.object(summarizer.client.chat.completions, 'create', new_callable=AsyncMock) as mock_create:
    ...
    async def test_summarize_single_entry(self, summarizer):
        ...
        entry = MemoryEntry(
            ...
            metadata=MemoryMetadata(created_at=datetime.now())
        )
    ...
    def test_build_prompt_chronological_order(self, summarizer):
        ...
        entries = [
            ...
            MemoryEntry(
                id="1",
                text="First",
                metadata=MemoryMetadata(created_at=base_time)
            ),
            MemoryEntry(
                id="3",
                text="Third",
